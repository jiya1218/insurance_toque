...
import { Shield, Search, FileText, Download, Filter, Plus, X } from 'lucide-react'
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-gray-50">
            {loading ? (
              ...
              <tr><td colSpan={5} className="p-10 text-center text-gray-400 italic">No policies found.</td></tr>
